def poker(hands):
    ...
    for x in range(1000):
        ...
        suits2 = []
        for y in range(5):
            nums1.append(hands[x*30+y*3])
            suits1.append(hands[x*30+y*3+1])
            nums2.append(hands[x*30+y*3+15])
            suits2.append(hands[x*30+y*3+16])
        ...
        cards1 = zip(nums1,suits1)
        cards2 = zip(nums2,suits2)
        cards1 = sorted(cards1)
        cards2 = sorted(cards2)
        nums1,suits1 = zip(*cards1)
        nums2,suits2 = zip(*cards2)
        nums1 = list(nums1)
        nums2 = list(nums2)
        suits1 = list(suits1)
        suits2 = list(suits2)
                
        if suits1[0] == suits1[1] == suits1[2] == suits1[3] == suits1[4]:
            if nums1[0] == 10 and nums1[1] == 11 and nums1[2] == 12 and nums1[3] == 13 and nums1[4] == 14:
                hand1 = 9
            elif int(nums1[0]) == int(nums1[1]) - 1 and int(nums1[1]) == int(nums1[2]) - 1 and int(nums1[2]) == int(nums1[3]) - 1 and int(nums1[3]) == int(nums1[4]) - 1:
                hand1 = 8
        elif nums1[0] == nums1[1] == nums1[2] == nums1[3] or nums1[4] == nums1[1] == nums1[2] == nums1[3]:
            hand1 = 7
        elif nums1[0] == nums1[1] == nums1[2] and nums1[3] == nums1[4] or nums1[0] == nums1[1] and nums1[2] == nums1[3] == nums1[4]:
            hand1 = 6
        elif suits1[0] == suits1[1] == suits1[2] == suits1[3] == suits1[4]:
            hand1 = 5
        elif int(nums1[0]) == int(nums1[1]) - 1 and int(nums1[1]) == int(nums1[2]) - 1 and int(nums1[2]) == int(nums1[3]) - 1 and int(nums1[3]) == int(nums1[4]) - 1:
            hand1 = 4
        elif nums1[0] == nums1[1] == nums1[2] or nums1[3] == nums1[1] == nums1[2] or nums1[2] == nums1[3] == nums1[4]:
            hand1 = 3
        elif nums1[0] == nums1[1] and nums1[2] == nums1[3] or nums1[0] == nums1[1] and nums1[3] == nums1[4] or nums1[1] == nums1[2] and nums1[3] == nums1[4]:
            hand1 = 2
        elif nums1[0] == nums1[1] or nums1[1] == nums1[2] or nums1[2] == nums1[3] or nums1[3] == nums1[4]:
            hand1 = 1
        else:
            hand1 = 0
            
        if suits2[0] == suits2[1] == suits2[2] == suits2[3] == suits2[4]:
            if nums2[0] == 10 and nums2[1] == 11 and nums2[2] == 12 and nums2[3] == 13 and nums2[4] == 14:
                hand2 = 9
            elif int(nums2[0]) == int(nums2[1]) - 1 and int(nums2[1]) == int(nums2[2]) - 1 and int(nums2[2]) == int(nums2[3]) - 1 and int(nums2[3]) == int(nums2[4]) - 1:
                hand2 = 8
        elif nums2[0] == nums2[1] == nums2[2] == nums2[3] or nums2[4] == nums2[1] == nums2[2] == nums2[3]:
            hand2 = 7
        elif nums2[0] == nums2[1] == nums2[2] and nums2[3] == nums2[4] or nums2[0] == nums2[1] and nums2[2] == nums2[3] == nums2[4]:
            hand2 = 6
        elif suits2[0] == suits2[1] == suits2[2] == suits2[3] == suits2[4]:
            hand2 = 5
        elif int(nums2[0]) == int(nums2[1]) - 1 and int(nums2[1]) == int(nums2[2]) - 1 and int(nums2[2]) == int(nums2[3]) - 1 and int(nums2[3]) == int(nums2[4]) - 1:
            hand2 = 4
        elif nums2[0] == nums2[1] == nums2[2] or nums2[3] == nums2[1] == nums2[2] or nums2[2] == nums2[3] == nums2[4]:
            hand2 = 3
        elif nums2[0] == nums2[1] and nums2[2] == nums2[3] or nums2[0] == nums2[1] and nums2[3] == nums2[4] or nums2[1] == nums2[2] and nums2[3] == nums2[4]:
            hand2 = 2
        elif nums2[0] == nums2[1] or nums2[1] == nums2[2] or nums2[2] == nums2[3] or nums2[3] == nums2[4]:
            hand2 = 1
        else:
            hand2 = 0
        ...
        if hand1 > hand2:
            ...
            if hand1 == 8 or hand1 == 7 or hand1 == 6 or hand1 == 5 or hand1 == 4 or hand1 == 3:
                if int(nums1[x]) > int(nums2[x]):
                    wins = wins + 1
    
            elif hand1 == 2:
                if int(nums1[3]) > int(nums2[3]):
                    wins = wins + 1
                elif int(nums1[3]) == int(nums2[3]):
                    if int(nums1[1]) > int(nums2[1]):
                        ...
                        for x in range(4,-1,-1):
                            if int(nums1[x]) > int(nums2[x]):
                                wins = wins + 1
                                break
                            elif int(nums1[x]) < int(nums2[x]):
                                break
                
            elif hand1 == 1:
                if nums1[4] == nums1[3]:
                    temp1 = nums1[4]
                elif nums1[3] == nums1[2]:
                    temp1 = nums1[3]
                elif nums1[2] == nums1[1]:
                    temp1 = nums1[2]
                elif nums1[1] == nums1[0]:
                    temp1 = nums1[1]
                    
                if nums2[4] == nums2[3]:
                    temp2 = nums2[4]
                elif nums2[3] == nums2[2]:
                    temp2 = nums2[3]
                elif nums2[2] == nums2[1]:
                    temp2 = nums2[2]
                elif nums2[1] == nums2[0]:
                    temp2 = nums2[1]
